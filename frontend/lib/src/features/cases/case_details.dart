                        ...
                        children: [
                          Expanded(
                            ...
                            child: GraphWidget(
                              ...
                              realWeek: List.generate(8,
                                  (index) => StockData(pointX: index / 2, pointY: Random().nextDouble() * 1000 + 300)),
                              predictedWeek: List.generate(
                                  2,
                                  (index) =>
                                      StockData(pointX: (8 + index) / 2, pointY: Random().nextDouble() * 1000 + 300)),
                              realMonth: List.generate(8,
                                  (index) => StockData(pointX: index * 2, pointY: Random().nextDouble() * 1000 + 300)),
                              predictedMonth: List.generate(
                                  2,
                                  (index) =>
                                      StockData(pointX: (8 + index) * 2, pointY: Random().nextDouble() * 1000 + 300)),
                              realHalfYear: List.generate(8,
                                  (index) => StockData(pointX: index / 2, pointY: Random().nextDouble() * 1000 + 300)),
